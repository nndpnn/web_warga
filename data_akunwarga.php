						...
						<tbody>
							...
							include('koneksi.php');
								if(isset($_GET['kata_cari'])) {
									...
									$query = "SELECT tb_akun.id_akun, tb_akun.username, tb_akun.password, tb_akun.role, tb_data_warga.id_warga, tb_data_warga.nama, tb_data_warga.alamat FROM tb_akun INNER JOIN tb_data_warga ON tb_akun.id_akun=tb_data_warga.id_akun";
								}
